...
const Shineray = [{ name: 'О компании' }, { name: 'О нас' }, { name: 'Видео обзоры' }, { name: 'Юридическая информация' }]
  ...
  return (
    <div className={styles.footerWrapper}>
      <div className={styles.footerWrapper_linkBar}>
        <span className={styles.footerWrapper_linkBar_title}>Модельный ряд</span>
      ...
      <div className={styles.footerWrapper_linkBar}>
        <span className={styles.footerWrapper_linkBar_title}>Мир Shineray</span>
      ...
      <div className={styles.footerWrapper_infoBar}>
        <img className={styles.footerWrapper_infoBar_logo} src={'https://www.shineray.com/upload/logo/1703907286103471.png'} />
        <span className={styles.footerWrapper_infoBar_contactInfo}>
          {'Мы в соцсетях:'}
          <SvgIcon
            sx={{ width: '2rem', height: '2rem', transition: 'ease-in 0.2s', ':hover': 'transform: scale: 1.1' }}
