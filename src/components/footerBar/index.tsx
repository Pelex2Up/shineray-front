...
export const Footer: FC = () => {
  const { data: FooterData } = useFetchHeaderDataQuery();
  return (
    <div className={styles.wrapper}>
      <div className={styles.footerWrapper}>
        <div className={styles.footerWrapper_linkBar}>
          <span className={styles.footerWrapper_linkBar_title}>
            Модельный ряд
          </span>
        ...
        <div className={styles.footerWrapper_infoBar}>
          ...
          <span className={styles.footerWrapper_infoBar_contactInfo}>
            {"Мы в соцсетях:"}
            <a
              href="https://www.instagram.com/shineray.by?igsh=MXFmd2FhNzF1djcwMg=="
              target="_blank"
              rel="noreferrer"
            ...
            >
              <SvgIcon
                ...
                className={styles.footerWrapper_infoBar_contactInfo_icon}
              >
                <svg
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61559643368490"
              target="_blank"
              rel="noreferrer"
              style={{ width: "2rem", height: "2rem" }}
            >
      ...
      <div className={styles.legalInformation}>
        <div className={styles.legalInformation_descr}>
          <p style={{ textAlign: "justify" }}>
            ООО “Лакшери Моторс групп”, УНП 193695595, официальный представитель
            и эксклюзивный дистрибьютор Shineray в Республике Беларусь, ведет
            деятельность на территории Республики Беларусь в соответствии с
            законодательством Республики Беларусь. Вся представленная на
            интернет-сайте информация носит исключительно
            информационно-ознакомительный характер и ни при каких условиях не
        ...
        >
          <div>
            <p>@2024, все права защищены ООО «Лакшери Моторс групп»</p>
            <p>
